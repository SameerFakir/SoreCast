...
import com.example.sorecastv1.Adapter.WeatherForecastAdapter;
...
public class ForecastFragment extends Fragment {
    ...
    public ForecastFragment() {
        ...
        mService = retrofit.create(IOpenWeatherMap.class); // Break here, try to fix
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //recycler_forecast.setBackgroundColor(getResources().getColor(R.color.colorAccent));
